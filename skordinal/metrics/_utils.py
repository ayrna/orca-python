...
def get_metric_names():
    ...
    These names can be passed to :func:`~skordinal.metrics.compute_metric` to
    ...
    Examples
    --------
    >>> from skordinal.metrics import get_metric_names
...
def greater_is_better(metric_name):
    ...
    Examples
    --------
    >>> from skordinal.metrics import greater_is_better
