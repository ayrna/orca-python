...
def test_check_params(util):
    ...
    util.configurations = {'conf1': {'classifier': 'sklearn.svm.SVC',
                                        'parameters': {'C': [0.1, 1, 10],
                                                'gamma': [0.1, 1, 100], 
                                                'probability': "True"}}}

    # Getting formatted_params and expected_params
    util._check_params(); formatted_params = util.configurations['conf1']['parameters']
    ...
    # Getting formatted_params and expected_params
    util._check_params(); formatted_params = util.configurations['conf2']['parameters']

    random_state = util.configurations['conf2']['parameters']['parameters'][0]['random_state']
    ...
    # Getting formatted_params and expected_params
    util._check_params(); formatted_params = util.configurations['conf3']['parameters']

    random_state = util.configurations['conf3']['parameters']['parameters']['random_state']
    expected_params = {	'dtype': 'OrderedPartitions',
                        'base_classifier': 'sklearn.svm.SVC',
